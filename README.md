...
**Ingeniero de Sistemas en formación @ EAFIT** | Data & Software  
*Apasionado por gestionar proyectos de datos y coordinar equipos técnicos*
...
### Data & Analytics (Prioridad Alta)
- **Python** - Desarrollo backend, análisis de datos, automatización
- **SQL** - Bases de datos relacionales y consultas
- **Pandas, NumPy** - Manipulación y análisis de datos
- **PostgreSQL, MySQL, MongoDB** - Bases de datos SQL y NoSQL
- **Apache Airflow** - Orquestación de pipelines de datos
- **dbt** - Transformación de datos y modelado analítico

### Cloud & DevOps
- **AWS** - EC2, S3, Lambda, RDS
- **Docker** - Contenedores y microservicios
- **Kubernetes** - Orquestación de contenedores (microk8s)
- **GitHub Actions** - CI/CD y automatización

### Lenguajes de Programación
- **Java** - Desarrollo de aplicaciones
- **C/C++** - Programación de sistemas, algoritmos y OpenMP
- **JavaScript** - Desarrollo frontend y web
- **HTML/CSS** - Desarrollo web y diseño de interfaces

### Desarrollo Web (Prioridad Media)
- **Backend** - Node.js/Express, Laravel, PHP, Python
- **Frontend** - React.js, HTML/CSS, JavaScript
- **APIs** - RESTful APIs, Microservicios
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Camiloesoto&show_icons=true&theme=default)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Camiloesoto&layout=compact&theme=default)

---

## Educación

- **Ingeniería de Sistemas** - Universidad EAFIT (2022 - Presente)
- **Certificación Internacional en Turismo y Tecnología** - ICTTS (2023)
- **Ingeniería Mecatrónica (Incompleta)** - Escuela de Ingenieros de Antioquia - EIA (2021-2022)
- **Bachillerato** - Colegio Padre Manyanet (2020)

### Educación No Formal
- **Curso de Python** - Coursera
- **Curso Scrum** - SCRUMstudy

---

## Experiencia de Liderazgo y Emprendimiento
...
- **Email:** [camiloesoto@gmail.com](mailto:camiloesoto@gmail.com)
- **Teléfono:** +57 314 573 6727
- **Ubicación:** Medellín, Colombia
- **GitHub:** [@Camiloesoto](https://github.com/Camiloesoto)
- **LinkedIn:** [Camilo Soto](#)
...
- [ ] Certificaciones en gestión de proyectos (PMP, Scrum Master)
- [ ] Especialización en Data Engineering
- [ ] Liderar equipos de desarrollo de datos
